  ...
  <div class="space-y-6">
    ...
    <div class="bg-white shadow-sm rounded-lg p-6 space-y-6">
      <div class="flex flex-wrap md:flex-nowrap items-center space-y-4 md:space-y-0 md:space-x-6">
        ...
        <!-- Edit Profile Button -->
        <button
          class="ml-auto bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center"
