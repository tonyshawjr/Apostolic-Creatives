<template>
          ...
          <div class="flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div class="w-full sm:w-auto sm:flex-1 sm:max-w-xl">
              <div class="relative">
                ...
                <input v-model="searchTerm" @input="searchJobs" type="text" placeholder="Search Active Jobs"
          ...
          <table class="w-full">
            <thead>
              <tr class="border-b border-gray-100">
                ...
                <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Posted Date</th>
            ...
            <tbody>
              <tr v-for="job in paginatedJobs" :key="job.id"
                ...
                <td class="px-6 py-4 text-gray-600">{{ job.postedDate }}</td>
  ...
  export default {
    ...
    methods: {
      ...
      editJob(jobId) {
        this.$router.push(`/dashboard/manage-jobs/job/edit/${jobId}`);
      },
