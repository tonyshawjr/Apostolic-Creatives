<template>
  <div class="space-y-6">
    <h1 class="text-2xl font-bold text-gray-800">Manage Team Members</h1>
...
export default {
  data() {
    return {
      searchTerm: "",
      users: [
        { id: 1, name: "Yomira Gomez", email: "yomira.gomez@example.com", role: "Team Member" },
  ...
  methods: {
    ...
    viewUser(userId) {
      this.$router.push({ name: "TeamMemberProfile", params: { id: userId } });
    },
  },
  mounted() {
